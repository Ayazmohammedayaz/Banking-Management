...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/phpfiles/css/navbar.css">
  <link rel="stylesheet" type="text/css" href="/phpfiles/css/script.css">
...
<body>
  <video autoplay muted loop id="player">
    <source src="mixkit-traveling-through-a-tunnel-of-black-cubes-in-3d-31497-medium" type="video/mp4" />
  </video>
  <div class="container">
    <div class="content">
      <?php
      ...
      <div class="headline">
        ...
        <div class="buttons">
          <a href="/phpfiles/transfermoney.php" class="get-started"> Send Money </a>
          <a href="/phpfiles/users.php" class="get-started"> Create User </a>
          <a href="/phpfiles/transactionhistory.php" class="read-more"> View Transactions </a>
        </div>
      </div>
    </div>
  </div>
  ...
  <footer class="ownership">
    <br>
    <center>
    <p>&copy 2023. Made by <b>MOHAMMED AYAZ</b> MOHAMMED Banks</p>
</center>
  </footer>
</body>
